...
my $filename = 'F:\doutorado\dados\resultadoCodeGenotype\resultadoGenotypeCallF09-3F.txt';
...
open(my $fh_log, '>>', 'F:\doutorado\dados\resultadosStatusCNV\statusCNVF09-3F.txt');
