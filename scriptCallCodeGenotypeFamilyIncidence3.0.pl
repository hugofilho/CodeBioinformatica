...
my $filename = 'D:\tr300872\Documents\Bckp 01-08-2014 disij70-trf1\D\Particular\doutorado\dados\output.strand.base.call.F04.txt';
...
open(my $fh_log, '>>', 'D:\tr300872\Documents\Bckp 01-08-2014 disij70-trf1\D\Particular\doutorado\dados\output.genotype.code.base.F04.txt');
  ...
  # if ($tx_confidence_mother gt '0.005' or $tx_confidence_offspring gt '0.005' or $tx_confidence_father gt '0.005') {
      ...
      # if ($call_base_mother ne '' or $call_base_father ne '' or $call_base_offspring ne '') {
          switch($call_code_mother) {
              ...
              case 'NoCall' {say $fh_log $reg;} #case NoCall code_mother              
          }# switch($call_code_mother) 
    #    }# if $call_base
    # }# if $call_code      
 # }# if $tx_confidence
